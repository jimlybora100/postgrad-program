...
> See the notebook: [`CODE`](machine-learning/FullCode_Personal_Loan_Campaign.ipynb)
...
> See the notebook: [`CODE`](intro-to-neural-networks/FullCode_ReneWind.ipynb)
...
> See the notebook: [`CODE`](./ecen360_project.ipynb)
...
> See the notebook: [`CODE`](intro-to-computer-networks/FullCode_HelmNet.ipynb)
